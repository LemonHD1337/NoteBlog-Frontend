...
const RecentlyPostedComponent = () => {
	...
	return (
		<div className={"w-full mt-20 m-3 flex flex-col items-center md:items-start  "}>
			...
			<PaginationComponent count={recentlyBlogs?.totalPages} currentPage={page} setPage={setPage} className={"md:self-center"} />
		</div>
	);
};
