...
import { BlogsFetch, DefaultProps } from "../interfaces.ts";
...
const PopularPosted = (props: DefaultProps) => {
	...
	return (
		<div className={"w-full h-[720px] bg-light-green flex flex-col items-center justify-center " + props.className}>
