const ContactPage = () =>{
    return(
        <main className={"w-full min-h-full flex flex-col items-center justify-center"}>
            <h1 className={"mb-[56px]"}><span>Contact</span> Us</h1>
            <div className={"h-[300px] flex"}>
                <section className={"w-[650px] h-full mr-[80px]"}>
                    <form action="" className={"w-[650px]"}>
                        <div className={"w-full flex gap-6 mb-6"}>
                            <input type="text" placeholder={"name"}
                                   className={"border border-input-border-color rounded w-1/2 p-1"}/>
                        ...
                        <button className={"w-[165px] border border-input-border-color h-[45px] text-white bg-input-border-color rounded"}>Send message</button>
                    </form>
                </section>
